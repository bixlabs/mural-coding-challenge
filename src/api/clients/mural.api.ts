...
const MURAL_API_KEY = import.meta.env.VITE_MURAL_API_KEY ?? 'mural-transfer-api-key';
export const MURAL_TRANSFER_API_KEY = import.meta.env.MURAL_TRANSFER_API_KEY ?? 'mural-transfer-api-key';

export const muralApi = ky.create({
